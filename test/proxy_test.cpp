...
TEST_CASE("Our forward proxy")
{
  ...
  SECTION("should reject all unexpected bodies, requests that aren't CONNECTs and invalid remote targets")
  {
    asio::io_context io;
    ...
    asio::spawn(
      [&](asio::yield_context yield) mutable
      {
        ...
        //
        {
          auto request = http::request<http::empty_body>(http::verb::connect, "www.google.com:1337", 11);
          request.keep_alive(true);
          request.prepare_payload();
